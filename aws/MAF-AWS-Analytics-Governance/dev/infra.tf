...
module "security_group_ec2" {
  source = "git::ssh://git@github.com/GS-MAFTech/iac-tf-modules.git//aws/security_group/?ref=v1.0.0"
  ...
  aws_vpc_id                 = "vpc-0ad6152d3d1dc3780"
...
module "ec2" {
    source            = "git::ssh://git@github.com/GS-MAFTech/iac-tf-modules.git//aws/ec2/?ref=v1.0.0"
    environment       = "dev"
    business_unit     = "Holdings"
    owner             = "Saif.Khan@maf.ae"
    project           = "IDQ"
    ...
    aws_instance_key_name         = "idq-key"
    aws_ami_name_regex            = "Golden-AMI-RHEL-7.6-Auth-Encrypted-Mar-2022"
    aws_kms_key_arn               = "arn:aws:kms:eu-west-1:013303105325:key/3cc694c2-7e04-4c31-b4d8-23778c1c1afa"
    aws_subnet_id                 = "subnet-059b3c6152393215e"
...
module "db" {
    source              = "git::ssh://git@github.com/GS-MAFTech/iac-tf-modules.git//aws/rds/?ref=v1.0.0"
  project             = "idq"
  environment         = "dev"
  business_unit       = "Holdings"
  owner               = "Saif.Khan@maf.ae"
  ...
  port     = 1521
  multi_az               = true
  subnet_ids             = ["subnet-059b3c6152393215e", "subnet-0ec5326dae876ec06"]
